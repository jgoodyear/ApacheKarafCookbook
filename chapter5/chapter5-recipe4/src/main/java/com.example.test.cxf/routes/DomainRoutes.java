...
import com.example.test.cxf.reportdomain.InputReportDomain;
import com.example.test.cxf.reportdomain.OutputReportDomain;
...
public class DomainRoutes extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("cxf:bean:reportDomain").id("domainService")
             .choice()
